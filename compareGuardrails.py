...
if Location=="y": # Case we search in a folder other than ./results and/or the files have non-standard names
   ...
   # LZ=olderSnapshotConfig["TestInformation"]["Landing Zone"][-1]
    ...
    olderSnapshotConfigName=olderDate+ "_" + type + role + "Config" + "_" + LicensePlate + "_LZ" + LZ + ".json"
    newerSnapshotConfigName=newerDate+ "_" + type + role + "Config" + "_" + LicensePlate + "_LZ" +  LZ + ".json"
 
    olderSnapshotPoliciesName=olderDate+ "_" + type + role + "Policies" + "_" + LicensePlate + "_LZ" +  LZ + ".json"
    newerSnapshotPoliciesName=newerDate+ "_" + type + role + "Policies" + "_" + LicensePlate + "_LZ" +  LZ + ".json"   
    
    compareFile(olderSnapshotConfigName,newerSnapshotConfigName,olderSnapshotPoliciesName,newerSnapshotPoliciesName)
